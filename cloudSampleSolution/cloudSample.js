...
function getDefaultDocumentTemplate() {
	var content = '<figure class="image image-style-align-left">\
		<img src="https://docs.google.com/drawings/u/2/d/sqTY9PPHoJ_grubeHm0JXUQ/image?w=816&amp;h=209&amp;rev=12&amp;ac=1&amp;parent=1chvZaE9c3etg_-hovDYZxouocPvBTfLQuOma-vSK2xA"></figure>\
		<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>\
		<h2><span class="mention svy-mention" data-mention="#customers.Company" data-real-value="orders_to_customers.companyname" contenteditable="true">#customers.Company</span>&nbsp;</h2>\
		<h4><span style="background-color:transparent;color:#31394d;">123 COMPANY STREET</span></h4><h4><span style="background-color:transparent;color:#31394d;">COMPANY CITY, ST 12345</span></h4>\
		<p>&nbsp;</p><p><span style="background-color:transparent;color:#31394d;">Order <span class="mention svy-mention" data-mention="#orders.OrderId" data-real-value="orderid" contenteditable="true">#orders.OrderId</span>&nbsp;</span></p>\
		<p><span style="background-color:transparent;color:#31394d;"><span class="mention svy-mention" data-mention="$startRepeater.OrderDetails" data-real-value="startRepeater-orders_to_order_details" contenteditable="true">$startRepeater.OrderDetails</span>&nbsp;</span></p>\
		<figure class="table"><table><thead><tr><th>ITEM</th><th>&nbsp; &nbsp; &nbsp;QTY</th><th>&nbsp; &nbsp; &nbsp;PRICE</th><th>&nbsp; &nbsp; &nbsp;SUBTOTAL</th></tr></thead>\
		<tbody><tr><td style="border-bottom:0.75pt solid #f3f3f3;border-left:0.75pt solid #f3f3f3;border-right:0.75pt solid #f3f3f3;border-top:0.75pt solid #f3f3f3;padding:2pt;">\
		<p style="margin-left:6pt;"><span class="mention svy-mention" data-mention="#products.Product" data-real-value="orders_to_order_details.order_details_to_products.productname" contenteditable="true">#products.Product</span>&nbsp;</p></td>\
		<td style="border-bottom:0.75pt solid #f3f3f3;border-left:0.75pt solid #f3f3f3;border-right:0.75pt solid #f3f3f3;border-top:0.75pt solid #f3f3f3;padding:2pt;">\
		<p style="text-align:right;"><span class="mention svy-mention" data-mention="#order_details.Quantity" data-real-value="orders_to_order_details.quantity" contenteditable="true">#order_details.Quantity</span>&nbsp;</p></td>\
		<td style="border-bottom:0.75pt solid #f3f3f3;border-left:0.75pt solid #f3f3f3;border-right:0.75pt solid #f3f3f3;border-top:0.75pt solid #f3f3f3;padding:2pt;">\
		<p style="text-align:right;"><span class="mention svy-mention" data-mention="#order_details.Price" data-real-value="orders_to_order_details.price" contenteditable="true">#order_details.Price</span>&nbsp;</p></td>\
		<td style="border-bottom:0.75pt solid #f3f3f3;border-left:0.75pt solid #f3f3f3;border-right:0.75pt solid #f3f3f3;border-top:0.75pt solid #f3f3f3;padding:2pt;">\
		<p style="text-align:right;"><span class="mention svy-mention" data-mention="#order_details.Subtotal" data-real-value="orders_to_order_details.subtotal" contenteditable="true">#order_details.Subtotal</span>&nbsp;</p></td></tr></tbody></table></figure>\
		<p><span class="mention svy-mention" data-mention="$endRepeater" data-real-value="" contenteditable="true">$endRepeater</span>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>'
	return content;
}
